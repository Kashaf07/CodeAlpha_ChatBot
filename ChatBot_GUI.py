...
class ChatbotApp:
    ...
    def generate_response(self, user_message):
        ...
        elif "how to start drawing" in doc.text:
            return "To start drawing, grab a pencil and paper, and begin with simple shapes like circles, squares, and lines. Practice regularly, and don’t be afraid to make mistakes—they're part of the process!"
        elif "what are some easy drawing ideas" in doc.text:
            return "Some easy drawing ideas include doodling flowers, sketching your favorite animal, drawing basic geometric patterns, or creating a simple landscape like mountains or a beach."
        elif "what is watercolor painting" in doc.text:
            return "Watercolor painting is a technique where artists use water-soluble pigments on paper to create soft, translucent effects. It's great for landscapes, portraits, and abstract art!"
        elif "how to improve my painting skills" in doc.text:
            return "To improve your painting skills, practice regularly, experiment with different mediums, study color theory, and learn from tutorials or online courses. Joining an art community can also provide valuable feedback."
        elif "what are some famous painting styles" in doc.text:
            return "Some famous painting styles include realism, impressionism, abstract, cubism, surrealism, and expressionism. Each style has its unique characteristics and techniques."
        elif "suggest some painting techniques" in doc.text:
            return "You can try techniques like blending, stippling, dry brushing, glazing, or using a palette knife for texture. Experimenting with these will help you discover your style!"
        elif "can you suggest art supplies for beginners" in doc.text:
            return "For beginners, start with basic supplies like pencils (HB, 2B, 4B), an eraser, sketchpad, watercolors, brushes, and acrylic paints. Gradually add more as you explore different techniques."
        elif "what is digital art" in doc.text:
            return "Digital art is created using digital tools like drawing tablets and software such as Adobe Photoshop, Procreate, or Krita. It's versatile and allows artists to experiment without physical materials."
        elif "how to get inspiration for art" in doc.text:
            return "Inspiration can come from anywhere! Try observing nature, listening to music, exploring emotions, or looking at other artists' work. Keeping an art journal can also spark ideas."
        elif "what is abstract art" in doc.text:
            return "Abstract art focuses on shapes, colors, and textures rather than realistic representations. It allows artists to express emotions and ideas in a non-traditional way."
        elif "what is a good art challenge to try" in doc.text:
            return "Try challenges like 'Inktober' (drawing with ink daily in October) or 'Draw This in Your Style' (redrawing others' artwork in your style). These challenges are fun and help improve your skills!"
